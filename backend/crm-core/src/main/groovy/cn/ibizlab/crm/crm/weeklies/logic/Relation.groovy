...
/**
 * 实体[WEEKLIES]处理逻辑[新建周报时加载关联信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * 新建周报时加载关联信息
 */
class Relation extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Relation.class)
    ...
    /**
     * 执行逻辑节点[获取当前用户名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充默认开始/结束时间]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
