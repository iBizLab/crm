...
/**
 * 实体[DEAL]处理逻辑[异步添加商机到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AsyncDealToWorkProgres extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AsyncDealToWorkProgres.class)
