...
/**
 * 实体[LEAD]处理逻辑[新建线索时添加到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddLeadtoWorkProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddLeadtoWorkProgress.class)
