...
/**
 * 实体[TASK]处理逻辑[新建活动时添加到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ManeuverToWorkProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ManeuverToWorkProgress.class)
