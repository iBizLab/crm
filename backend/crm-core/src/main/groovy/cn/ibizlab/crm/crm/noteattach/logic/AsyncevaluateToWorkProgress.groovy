...
/**
 * 实体[NOTE_ATTACH]处理逻辑[异步添加评估到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AsyncevaluateToWorkProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AsyncevaluateToWorkProgress.class)
    ...
    /**
     * 执行逻辑节点[异步将评估更新到工作进展]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
