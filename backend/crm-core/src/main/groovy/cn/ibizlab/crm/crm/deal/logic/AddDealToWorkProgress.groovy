...
/**
 * 实体[DEAL]处理逻辑[新建商机时添加到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddDealToWorkProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddDealToWorkProgress.class)
