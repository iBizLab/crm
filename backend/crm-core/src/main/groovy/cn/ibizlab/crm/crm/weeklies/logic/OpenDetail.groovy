...
/**
 * 实体[WEEKLIES]处理逻辑[打开详情页获取关联数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * 打开详情页获取关联数据
 */
class OpenDetail extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OpenDetail.class)
    ...
    /**
     * 执行逻辑节点[新建的商机或线索]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
