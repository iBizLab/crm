package cn.ibizlab.crm.crm.payeeplan.logic
...
/**
 * 实体[PAYEE_PLAN]处理逻辑[将数据传给记录]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将计划数据（金额、描述等）传给记录
 */
class PlanToPayee extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PlanToPayee.class)
    ...
    /**
     * 执行逻辑节点[将所需数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
