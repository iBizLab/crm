...
/**
 * 实体[TASK]处理逻辑[关闭任务]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ClosedTaskormaneuver extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ClosedTaskormaneuver.class)
    ...
    /**
     * 执行逻辑节点[将状态变为完成]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
