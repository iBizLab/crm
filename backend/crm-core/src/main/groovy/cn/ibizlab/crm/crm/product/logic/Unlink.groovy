package cn.ibizlab.crm.crm.product.logic
...
/**
 * 实体[PRODUCT]处理逻辑[取消关联]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Unlink extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Unlink.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "DEDATAQUERY1":
                //执行逻辑节点[查询管理数据]
                executeDEDATAQUERY1(iDELogicSession, iPSDELogicNode)
                break
            case "BINDPARAM1":
                //执行逻辑节点[获取关联数据]
    ...
    /**
     * 执行逻辑节点[设置查询条件]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询管理数据]，逻辑类型[DEDATAQUERY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    private void executeDEDATAQUERY1(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }

    /**
     * 执行逻辑节点[获取关联数据]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
