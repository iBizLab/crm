...
/**
 * 实体[DEAL]处理逻辑[新建商机时生成阶段历史]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ScCreatedealstagehis extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ScCreatedealstagehis.class)
