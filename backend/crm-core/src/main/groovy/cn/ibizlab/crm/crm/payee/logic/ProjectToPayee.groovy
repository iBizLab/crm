...
/**
 * 实体[PAYEE]处理逻辑[将订单分配传入收款记录]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ProjectToPayee extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProjectToPayee.class)
    ...
    /**
     * 执行逻辑节点[每次sub数据]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
