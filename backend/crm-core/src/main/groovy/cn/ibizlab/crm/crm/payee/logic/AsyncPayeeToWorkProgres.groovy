...
/**
 * 实体[PAYEE]处理逻辑[异步添加收款记录到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AsyncPayeeToWorkProgres extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AsyncPayeeToWorkProgres.class)
    ...
    /**
     * 执行逻辑节点[异步添加收款记录到工作进展]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
