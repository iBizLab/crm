package cn.ibizlab.crm.crm.payee.logic
...
/**
 * 实体[PAYEE]处理逻辑[新建收款记录添加到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddPayeeToWorkProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddPayeeToWorkProgress.class)
