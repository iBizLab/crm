package cn.ibizlab.crm.crm.executor

import java.util.List
import org.springframework.data.domain.Page

import cn.ibizlab.crm.crm.executor.dto.*
...
class Executor extends GroovyDataEntityRuntime<Executor,ExecutorDTO,ExecutorFilterDTO> {
    ...
    public static final String DATASET_LEAD_NOTIFY = "lead_notify"
    public static final String DATASET_PROJECT_NOTIFY = "project_notify"
     ...
     * @throws Throwable
     */
    @DEDataSet(DATASET_LEAD_NOTIFY)
    Page<ExecutorDTO> fetchLeadNotify(ExecutorFilterDTO context) throws Throwable {
        return this.fetch(DATASET_LEAD_NOTIFY, context, ExecutorDTO.class)
    }
     ...
     * @throws Throwable
     */
    @DEDataSet(DATASET_PROJECT_NOTIFY)
    Page<ExecutorDTO> fetchProjectNotify(ExecutorFilterDTO context) throws Throwable {
        return this.fetch(DATASET_PROJECT_NOTIFY, context, ExecutorDTO.class)
    }
