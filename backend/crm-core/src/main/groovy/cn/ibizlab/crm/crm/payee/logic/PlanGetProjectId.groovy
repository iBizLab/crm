...
/**
 * 实体[PAYEE]处理逻辑[通过project_id获取记录信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * 通过project_id获取记录信息
 */
class PlanGetProjectId extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PlanGetProjectId.class)
