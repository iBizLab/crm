...
/**
 * 实体[PROJECT]处理逻辑[异步添加订单到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AsyncProjectToWorkProgres extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AsyncProjectToWorkProgres.class)
    ...
    /**
     * 执行逻辑节点[异步将线索更新到工作进展]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
