package cn.ibizlab.crm.crm.project.logic
...
/**
 * 实体[PROJECT]处理逻辑[新建订单时添加到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddProjectToWorkProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddProjectToWorkProgress.class)
    ...
    /**
     * 执行逻辑节点[准备工作进展参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
