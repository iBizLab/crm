...
/**
 * 实体[PAYEE_STATISTIC]处理逻辑[将分配数据更新到统计表]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class UpdatePayeeAllocate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdatePayeeAllocate.class)
