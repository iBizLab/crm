...
/**
 * 实体[LEAD]处理逻辑[异步添加线索到工作进展]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AsyncLeadtoWorkProgres extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AsyncLeadtoWorkProgres.class)
