...
/**
 * 实体[PRODUCT]处理逻辑[添加产品]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddProduct extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[获取选择产品集合]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环获取产品数据集]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[拷贝产品数据至中间对象]，逻辑类型[COPYPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
