package cn.ibizlab.crm.crm.account.logic
...
/**
 * 实体[ACCOUNT]处理逻辑[删除被合并客户]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DeleteMarge extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteMarge.class)
