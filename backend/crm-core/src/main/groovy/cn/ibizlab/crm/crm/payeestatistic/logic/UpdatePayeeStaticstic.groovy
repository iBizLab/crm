package cn.ibizlab.crm.crm.payeestatistic.logic
...
/**
 * 实体[PAYEE_STATISTIC]处理逻辑[将计划数据更新到统计表]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class UpdatePayeeStaticstic extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdatePayeeStaticstic.class)
    ...
    /**
     * 执行逻辑节点[循环获取计划数据]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
