...
/**
 * 实体[TASK]处理逻辑[取消关联(商机)]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DealCancelRelation extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DealCancelRelation.class)
