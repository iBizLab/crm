...
/**
 * 实体[DEAL]处理逻辑[商机阶段更新时生成历史]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Scdealstagehis extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Scdealstagehis.class)
    ...
    /**
     * 执行逻辑节点[查询历史阶段持续天数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[阶段历史对象属性赋值]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
