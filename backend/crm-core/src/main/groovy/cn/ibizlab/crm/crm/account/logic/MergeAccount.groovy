...
/**
 * 实体[ACCOUNT]处理逻辑[合并客户]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在填入重复客户的时候将客户合并为一个
 */
class MergeAccount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MergeAccount.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "DEDATASET6":
                //执行逻辑节点[实体数据集]
                executeDEDATASET6(iDELogicSession, iPSDELogicNode)
                break
            case "DEDATASET7":
                //执行逻辑节点[实体数据集]
                executeDEDATASET7(iDELogicSession, iPSDELogicNode)
                break
            case "DEDATASET8":
                //执行逻辑节点[实体数据集]
                executeDEDATASET8(iDELogicSession, iPSDELogicNode)
                break
            case "LOOPSUBCALL1":
                //执行逻辑节点[循环子调用]
            ...
            case "LOOPSUBCALL4":
                //执行逻辑节点[循环子调用]
                executeLOOPSUBCALL4(iDELogicSession, iPSDELogicNode)
                break
            case "LOOPSUBCALL5":
                //执行逻辑节点[循环子调用]
            ...
            case "LOOPSUBCALL6":
                //执行逻辑节点[循环子调用]
                executeLOOPSUBCALL6(iDELogicSession, iPSDELogicNode)
                break
            case "LOOPSUBCALL7":
                //执行逻辑节点[循环子调用]
                executeLOOPSUBCALL7(iDELogicSession, iPSDELogicNode)
                break
            case "LOOPSUBCALL8":
                //执行逻辑节点[循环子调用]
                executeLOOPSUBCALL8(iDELogicSession, iPSDELogicNode)
                break
            case "PREPAREPARAM16":
                //执行逻辑节点[准备参数]
                executePREPAREPARAM16(iDELogicSession, iPSDELogicNode)
                break
            case "PREPAREPARAM10":
                //执行逻辑节点[准备参数]
            ...
            case "PREPAREPARAM14":
                //执行逻辑节点[准备参数]
                executePREPAREPARAM14(iDELogicSession, iPSDELogicNode)
                break
            case "PREPAREPARAM15":
                //执行逻辑节点[准备参数]
                executePREPAREPARAM15(iDELogicSession, iPSDELogicNode)
                break
            case "PREPAREPARAM17":
                //执行逻辑节点[准备参数]
                executePREPAREPARAM17(iDELogicSession, iPSDELogicNode)
                break
            case "DEACTION2":
                //执行逻辑节点[实体行为]
     ...
     * @throws Throwable
     */
    private void executeDEDATASET6(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeDEDATASET7(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeDEDATASET8(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeLOOPSUBCALL4(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeLOOPSUBCALL6(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeLOOPSUBCALL7(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeLOOPSUBCALL8(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executePREPAREPARAM16(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executePREPAREPARAM14(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executePREPAREPARAM15(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executePREPAREPARAM17(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
