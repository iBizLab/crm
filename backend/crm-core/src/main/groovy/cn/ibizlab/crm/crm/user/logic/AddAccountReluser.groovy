...
/**
 * 实体[USER]处理逻辑[添加客户关联销售]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddAccountReluser extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddAccountReluser.class)
    ...
    /**
     * 执行逻辑节点[获取选择用户集合]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环获取用户数据集]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[拷贝用户数据至中间对象]，逻辑类型[COPYPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
