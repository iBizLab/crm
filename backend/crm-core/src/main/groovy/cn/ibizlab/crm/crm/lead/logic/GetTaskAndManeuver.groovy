...
/**
 * 实体[LEAD]处理逻辑[获取线索关联任务和活动]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetTaskAndManeuver extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetTaskAndManeuver.class)
    ...
    /**
     * 执行逻辑节点[获取线索关联任务和活动]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
