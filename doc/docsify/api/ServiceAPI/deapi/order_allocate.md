# 订单分配(order_allocate) :id=order_allocate
## 创建订单分配
...
<el-alert title="/order_allocates" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
|<el-row justify="space-between"><el-col :span="20">ratio</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|BigDecimal|分配比率|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/fetch_all" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/exportdata/{param},/order_allocates/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/order_allocates/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
