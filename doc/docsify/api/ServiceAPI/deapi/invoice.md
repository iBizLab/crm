...
<el-alert title="/invoices" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
|<el-row justify="space-between"><el-col :span="20">invoice_date</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Timestamp|发货单日期|
|<el-row justify="space-between"><el-col :span="20">invoice_number</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|发货单编号|
...
|<el-row justify="space-between"><el-col :span="20">purchase_order</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|采购订单|
|<el-row justify="space-between"><el-col :span="20">sales_commissio</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|销售佣金|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/{key}/add_tags" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/{key}/batch_update" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/create_task" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/{key}/delete_tags" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/{key}/main_view_dr_count" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/exportdata/{param},/invoices/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/invoices/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
