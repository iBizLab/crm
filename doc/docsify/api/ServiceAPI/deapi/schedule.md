...
<el-alert title="/schedules" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
|<el-row justify="space-between"><el-col :span="20">is_close</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|是否关闭|
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_all" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_close" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_createman" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_index_der" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_not_close" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/fetch_owner" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/exportdata/{param},/schedules/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/schedules/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
