...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/{key}/main_view_dr_count" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/{key}/move_order" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`UPDATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/plan_info_by_project" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/project_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/fetch_all" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
|<el-row justify="space-between"><el-col :span="20">n_payee_date_gt</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Timestamp|收款日期|
|<el-row justify="space-between"><el-col :span="20">n_payee_date_gtandeq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Timestamp|收款日期|
|<el-row justify="space-between"><el-col :span="20">n_payee_date_in</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Timestamp|收款日期|
|<el-row justify="space-between"><el-col :span="20">n_payee_date_ltandeq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|Timestamp|收款日期|
|<el-row justify="space-between"><el-col :span="20">n_payee_plan_id_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|收款计划标识|
|<el-row justify="space-between"><el-col :span="20">n_plan_name_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|计划名称|
...
|<el-row justify="space-between"><el-col :span="20">n_project_id_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|订单标识|
...
```json
{
  ...
  "n_id_eq" : null,
  "n_name_like" : null,
  "n_payee_date_gt" : null,
  "n_payee_date_gtandeq" : null,
  "n_payee_date_in" : null,
  "n_payee_date_ltandeq" : null,
  "n_payee_plan_id_eq" : null,
  "n_plan_name_eq" : null,
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/fetch_createman" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/fetch_executor" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/fetch_sum" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/fetch_tree" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/exportdata/{param},/payees/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/payees/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/account_from_plan" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/add_payee_to_work_progress" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/add_tags" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/allocate_from_project" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/async_add_payee_to_work_progress" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/batch_update" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/create_task" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/delete_tags" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/main_view_dr_count" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/{key}/move_order" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/plan_info_by_project" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/project_info" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/fetch_all" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/fetch_createman" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/fetch_executor" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/fetch_sum" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/fetch_tree" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/exportdata/{param},/projects/{pkey}/payees/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/projects/{pkey}/payees/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
