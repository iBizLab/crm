...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{key}/main_view_dr_count" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{key}/merge_account" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`NONE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`CREATE`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_all" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
|<el-row justify="space-between"><el-col :span="20">n_account_number_like</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|客户编号|
|<el-row justify="space-between"><el-col :span="20">n_account_site_like</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|客户所在地|
|<el-row justify="space-between"><el-col :span="20">n_account_type_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|客户类型|
...
|<el-row justify="space-between"><el-col :span="20">n_industry_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|所属行业|
...
|<el-row justify="space-between"><el-col :span="20">n_ownership_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|公司所有权|
|<el-row justify="space-between"><el-col :span="20">n_paccount_name_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|父客户|
|<el-row justify="space-between"><el-col :span="20">n_paccount_name_like</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|父客户|
|<el-row justify="space-between"><el-col :span="20">n_phone_like</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|电话|
...
|<el-row justify="space-between"><el-col :span="20">n_rating_eq</el-col><el-col :span="4" style="text-align:right"><el-text size="small" type="success">可选</el-text></el-col> </el-row>|String|等级|
...
```json
{
  ...
  "n_account_number_like" : null,
  "n_account_site_like" : null,
  "n_account_type_eq" : null,
  ...
  "n_owner_eq" : null,
  "n_ownership_eq" : null,
  "n_paccount_name_eq" : null,
  "n_paccount_name_like" : null,
  "n_phone_like" : null,
  "n_pid_eq" : null,
  "n_rating_eq" : null,
}
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_assigned" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_createman" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_current" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_not_current" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_owner" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/fetch_target_relation" type="info" :closable="false" ></el-alert>
</div>
</el-row>
权限标识：`READ`
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/exportdata/{param},/accounts/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}/add_tags" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}/batch_update" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/check_key" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/create_task" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}/delete_tags" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}/find_account" type="info" :closable="false" ></el-alert>
</div>
</el-row>
反查客户信息
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/get_draft" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}/main_view_dr_count" type="info" :closable="false" ></el-alert>
</div>
</el-row>
自动生成
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/{key}/merge_account" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/save" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_all" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_assigned" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_createman" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_current" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_default" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_not_current" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_owner" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/fetch_target_relation" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/importtemplate" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/exportdata/{param},/accounts/{pkey}/accounts/exportdata/{param}/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/importdata" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/importdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/asyncimportdata2" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/printdata/{key}" type="info" :closable="false" ></el-alert>
</div>
</el-row>
...
<div style="margin-left:5px;width: calc(100% - 85px)">
<el-alert title="/accounts/{pkey}/accounts/report" type="info" :closable="false" ></el-alert>
</div>
</el-row>
