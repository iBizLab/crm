# 备注(purchase_order_note_attach_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [采购订单(PURCHASE_ORDER)](module/crm/purchase_order) : [清空评论](module/crm/purchase_order#界面行为)
  * [采购订单(PURCHASE_ORDER)](module/crm/purchase_order) : [发送评论](module/crm/purchase_order#界面行为)
