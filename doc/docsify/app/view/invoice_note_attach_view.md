# 备注(invoice_note_attach_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [发货单(INVOICE)](module/crm/invoice) : [清空评论](module/crm/invoice#界面行为)
  * [发货单(INVOICE)](module/crm/invoice) : [发送评论](module/crm/invoice#界面行为)
