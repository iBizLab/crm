# 备注(solution_note_attach_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [解决方案(SOLUTION)](module/crm/solution) : [发送评论](module/crm/solution#界面行为)
  * [解决方案(SOLUTION)](module/crm/solution) : [清空评论](module/crm/solution#界面行为)
