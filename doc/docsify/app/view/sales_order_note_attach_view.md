# 备注(sales_order_note_attach_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [销售订单(SALES_ORDER)](module/crm/sales_order) : [发送评论](module/crm/sales_order#界面行为)
  * [销售订单(SALES_ORDER)](module/crm/sales_order) : [清空评论](module/crm/sales_order#界面行为)
