# 进展情况(task_note_condition_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [任务&活动(TASK)](module/crm/task) : [清空评论](module/crm/task#界面行为)
  * [任务&活动(TASK)](module/crm/task) : [发送评论](module/crm/task#界面行为)
