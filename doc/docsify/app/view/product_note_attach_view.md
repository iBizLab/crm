# 备注(product_note_attach_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [产品(PRODUCT)](module/crm/product) : [发送评论](module/crm/product#界面行为)
  * [产品(PRODUCT)](module/crm/product) : [清空评论](module/crm/product#界面行为)
