# 进展评估(price_book_note_attach_view)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  * [价格表(PRICE_BOOK)](module/crm/price_book) : [清空评论](module/crm/price_book#界面行为)
  * [价格表(PRICE_BOOK)](module/crm/price_book) : [发送评论](module/crm/price_book#界面行为)
