export default {
  ...
  appDEMethodDTOs: [
    ...
    {
      codeName: 'deal_stage_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
  ...
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'deal_stage_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'deal_stage_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'deal_stage',
  deapicodeName: 'deal_stage',
  deapicodeName2: 'deal_stages',
  deapitag: 'DEAL_STAGE',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  ...
  major: true,
  name: 'DEAL_STAGE',
  id: 'crmweb.deal_stage',
  codeName2: 'deal_stages',
  requestPaths: [],
};
