export default {
  ...
  appDEMethodDTOs: [
    ...
    {
      codeName: 'reservation_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
  ...
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'reservation_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'reservation_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  deapicodeName: 'reservation',
  deapicodeName2: 'reservations',
  deapitag: 'RESERVATION',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  ...
  major: true,
  name: 'RESERVATION',
  id: 'crmweb.reservation',
  codeName2: 'reservations',
  requestPaths: [],
};
