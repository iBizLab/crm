export default {
  ...
  deviewId: '344ae733a24270e073b8138437ccb498',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_PROGRESS',
  },
  caption: '工作进展',
  codeName: 'work_progress_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.WORK_PROGRESS.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '工作进展基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.WORK_PROGRESS.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.WORK_PROGRESS.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.WORK_PROGRESS.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
      ...
      modelId: '43e63f8072833d6618ccfa7182794db1',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'crmweb.work_progress.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'def43df50d6795473b518b31cbba89c1',
  modelType: 'PSAPPDEVIEW',
  name: 'work_progressEditView',
  id: 'crmweb.work_progress_edit_view',
};
