export default {
  ...
  deviewId: '62aab086bb15475fb8b5f9fee9a29f34',
  accUserMode: 2,
  caption: '备注',
  codeName: 'purchase_order_note_attach_view',
    ...
    controls: [
      {
                ...
                deformDetails: [
                  {
                    ...
                    parentDataJO: {
                      srfparentdename: 'PURCHASE_ORDER',
        ...
        modelId: '304e54394294caa1a77c8e787249cb80',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'crmweb.purchase_order.note_attach_view_form',
      },
      {
        caption: '备注',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '4a13b68b84159fcfb3c8dc0a4dee8ad7',
  modelType: 'PSAPPDEVIEW',
  name: 'purchase_ordernote_attach_view',
  id: 'crmweb.purchase_order_note_attach_view',
};
