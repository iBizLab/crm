export default {
  ...
  loadDefault: true,
  deviewCodeName: 'note_condition_view',
  deviewId: 'e9325a638ce3ec0e5c58dbf74a4ba6f6',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.TASK.NOTE_ATTACH_VIEW',
  },
  caption: '进展情况',
  codeName: 'task_note_condition_view',
    ...
    controls: [
      {
            ...
            deformDetails: [
              {
                ...
                capLanguageRes: {
                  lanResTag:
                    'CONTROL.DEFORM.TASK.NOTE_ATTACH_VIEW_FORM.GROUPPANEL.GROUPPANEL1',
                },
                caption: '进展情况',
        ...
        codeName: 'note_condition_view_form',
        controlType: 'FORM',
        logicName: '备注_表单（工作）',
        appDataEntityId: 'crmweb.task',
        controlParam: {
        ...
        modelId: 'd25888cfd84a06dae57b0664d7aaae3b',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'crmweb.task.note_condition_view_form',
      },
      {
        capLanguageRes: {
          lanResTag: 'PAGE.CAPTION.TASK.NOTE_ATTACH_VIEW',
        ...
        caption: '进展情况',
        codeName: 'note_condition_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'crmweb.task',
        controlParam: {},
        name: 'captionbar',
        id: 'note_condition_view_captionbar',
      },
    ],
  ...
  title: '进展情况',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.TASK.NOTE_ATTACH_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEEDITVIEW9',
  enableDP: true,
  showCaptionBar: true,
  modelId: '11fe4bba51a3f2d6db2fe3d3eb3822f0',
  modelType: 'PSAPPDEVIEW',
  name: 'tasknote_condition_view',
  id: 'crmweb.task_note_condition_view',
};
