export default {
  ...
  deviewId: '8883653943f04588ff87bfffae813ebc',
  accUserMode: 2,
  caption: '解决方案',
  codeName: 'solution_edit_view',
  ...
  controls: [
    ...
    },
    {
      ...
      modelId: 'ebd4a7a0b6cd5a2e2e2cd172b728ec1d',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'crmweb.solution.edit_view_form',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'ef1311e91f212f50f6814dff0eb784aa',
  modelType: 'PSAPPDEVIEW',
  name: 'solutionedit_view',
  id: 'crmweb.solution_edit_view',
};
