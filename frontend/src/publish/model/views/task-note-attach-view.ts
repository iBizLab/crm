export default {
  ...
  deviewId: 'ed91759ed05e99139b412d3926a5eb11',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.TASK.NOTE_ATTACH_VIEW',
  },
  caption: '进展评估',
  codeName: 'task_note_attach_view',
    ...
    controls: [
      {
        ...
        modelId: 'deb89a4480d08e5dfd7f6142795273f2',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'crmweb.task.note_attach_view_form',
      },
      {
        capLanguageRes: {
          lanResTag: 'PAGE.CAPTION.TASK.NOTE_ATTACH_VIEW',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '58c16a93e8e367f3af0d476a197e2545',
  modelType: 'PSAPPDEVIEW',
  name: 'tasknote_attach_view',
  id: 'crmweb.task_note_attach_view',
};
