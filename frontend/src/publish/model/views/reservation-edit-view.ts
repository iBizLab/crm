export default {
  ...
  deviewId: 'a216fdbab4229375c09e718a0de4007e',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RESERVATION',
  },
  caption: '预留',
  codeName: 'reservation_edit_view',
  appDataEntityId: 'crmweb.reservation',
  appViewEngines: [
    {
      engineCat: 'VIEW',
      engineType: 'EditView',
  ...
  controls: [
    ...
    },
    {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag: 'CONTROL.DEFORM.RESERVATION.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '预留基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.RESERVATION.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag: 'CONTROL.DEFORM.RESERVATION.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.RESERVATION.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
      ...
      modelId: '601dd554ff9f5a8e3ea4c50570df4fb0',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'crmweb.reservation.main',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '66a5e08635ab3cc90ca08ad1f2e6e23c',
  modelType: 'PSAPPDEVIEW',
  name: 'reservationEditView',
  id: 'crmweb.reservation_edit_view',
};
