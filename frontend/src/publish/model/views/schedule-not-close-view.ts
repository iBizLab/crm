export default {
  ...
  loadDefault: true,
  deviewCodeName: 'not_close_view',
  deviewId: '0b695881f0d8149c2e4e4253709497a5',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.SCHEDULE.NOT_CLOSE_VIEW',
  },
  caption: '待办任务',
  codeName: 'schedule_not_close_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'not_close_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '未关闭页面工具栏',
      appDataEntityId: 'crmweb.schedule',
      controlParam: {
      ...
      modelId: '7adcb23c2d117c8bb494725cbea1f557',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'not_close_view_toolbar',
    },
    {
      aggMode: 'NONE',
    ...
    },
    {
      ...
      caption: '待办任务',
      codeName: 'not_close_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'crmweb.schedule',
      controlParam: {},
      name: 'captionbar',
      id: 'not_close_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '待办任务',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.SCHEDULE.NOT_CLOSE_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '847c493941493b5b836511b48001cbad',
  modelType: 'PSAPPDEVIEW',
  name: 'schedulenot_close_view',
  id: 'crmweb.schedule_not_close_view',
};
